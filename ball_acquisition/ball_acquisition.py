    ...
    def find_best_candidate_for_possession(self, ball_center,player_tracks_frame, ball_bbox):
        ...
        for player_id, player_info in player_tracks_frame.items():
            ...
            if containment > self.containment_threshold:
                ...
                regular_containment_players.append((player_id, min_distance))
        ...
        # Second priority regular_containment_players
        if regular_containment_players:
            best_candidate = min(regular_containment_players, key = lambda x: x[1])
